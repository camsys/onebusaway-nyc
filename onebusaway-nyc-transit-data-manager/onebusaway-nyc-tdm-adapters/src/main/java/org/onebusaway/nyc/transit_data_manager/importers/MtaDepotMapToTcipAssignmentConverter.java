...
public class MtaDepotMapToTcipAssignmentConverter {
   ...
   * @return
   */
  public CPTFleetSubsetGroup ConvertToOutput(
      String depotStr, List<MtaBusDepotAssignment> list) {
  ...
  private GroupMembers generateGroupMembers (List<MtaBusDepotAssignment> bdAssigns) {
