...
public class CrewConverter {
	...
	public CrewConverter (String inputFilePath, String outputFilePath) throws IOException {
    ...
    private String generateXml (SchPushOperatorAssignments inputElement) throws JAXBException {
