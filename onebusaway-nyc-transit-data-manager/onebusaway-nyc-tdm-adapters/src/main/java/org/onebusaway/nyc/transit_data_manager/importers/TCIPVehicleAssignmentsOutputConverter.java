...
public class TCIPVehicleAssignmentsOutputConverter implements VehicleAssignmentsOutputConverter {
	
	private List<MtaUtsVehiclePullInPullOut> vehicleAssignInputData = null;
	
	public TCIPVehicleAssignmentsOutputConverter (List<MtaUtsVehiclePullInPullOut> data) {
