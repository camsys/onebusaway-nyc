 ...
 *         &lt;element name="incidentDataSets">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="incidentDataSet" type="{http://www.TCIP-Final-3-0-5-1}IMIncidentInfo"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class ImIncidentList {
    ...
    @XmlElement(required = true)
    protected ImIncidentList.IncidentDataSets incidentDataSets;
    ...
    /**
     * Gets the value of the incidentDataSets property.
     * 
     * @return
     *     possible object is
     *     {@link ImIncidentList.IncidentDataSets }
     *     
     */
    public ImIncidentList.IncidentDataSets getIncidentDataSets() {
        return incidentDataSets;
    }

    /**
     * Sets the value of the incidentDataSets property.
     * 
     * @param value
     *     allowed object is
     *     {@link ImIncidentList.IncidentDataSets }
     *     
     */
    public void setIncidentDataSets(ImIncidentList.IncidentDataSets value) {
        this.incidentDataSets = value;
    }
    ...
    public static class IncidentDataSets {

        @XmlElement(required = true)
        protected List<IMIncidentInfo> incidentDataSet;

        /**
         * Gets the value of the incidentDataSet property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the incidentDataSet property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getIncidentDataSet().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<IMIncidentInfo> getIncidentDataSet() {
            if (incidentDataSet == null) {
                incidentDataSet = new ArrayList<IMIncidentInfo>();
            }
            return this.incidentDataSet;
        }
