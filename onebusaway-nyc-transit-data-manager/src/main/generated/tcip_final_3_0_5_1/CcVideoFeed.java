...
/**
 * <p>Java class for CcVideoFeed complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CcVideoFeed">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="subscriptionInfo" type="{http://www.TCIP-Final-3-0-5-1}CPTSubscriptionHeader"/>
 *         &lt;element name="cameras" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="camera" type="{http://www.TCIP-Final-3-0-5-1}CPT-GenericCounter"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="image" type="{http://www.TCIP-Final-3-0-5-1}PI-BinaryVideoData"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "CcVideoFeed", propOrder = {
    "subscriptionInfo",
    "cameras",
    "begin",
    "format",
...
public class CcVideoFeed {

    @XmlElement(required = true)
    protected CPTSubscriptionHeader subscriptionInfo;
    protected CcVideoFeed.Cameras cameras;
    protected String begin;
    @XmlElement(required = true)
    protected String format;
    @XmlElement(required = true)
    protected CcVideoFeed.Images images;
     ...
     * @return
     *     possible object is
     *     {@link CcVideoFeed.Cameras }
     *     
     */
    public CcVideoFeed.Cameras getCameras() {
        return cameras;
    }
     ...
     *     
     */
    public void setCameras(CcVideoFeed.Cameras value) {
        this.cameras = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link CcVideoFeed.Images }
     *     
     */
    public CcVideoFeed.Images getImages() {
        return images;
    }
     ...
     *     
     */
    public void setImages(CcVideoFeed.Images value) {
        this.images = value;
    }
    ...
    public static class Cameras {
         ...
         * 
         */
        public List<Long> getCamera() {
            if (camera == null) {
                camera = new ArrayList<Long>();
            }
            return this.camera;
        }
    ...
    public static class Images {
        ...
        @XmlElement(required = true)
        protected List<PIBinaryVideoData> image;
         ...
         * 
         */
        public List<PIBinaryVideoData> getImage() {
            if (image == null) {
                image = new ArrayList<PIBinaryVideoData>();
            }
            return this.image;
        }
