 ...
 *         &lt;element name="actual-start-time" type="{http://www.TCIP-Final-3-0-5-1}CPT-DateTime"/>
 *         &lt;element name="trip-info" type="{http://www.TCIP-Final-3-0-5-1}CCPTVTripData"/>
 *         &lt;element name="localObNotifyTripStart" type="{http://www.tcip-3-0-5-local}ObNotifyTripStart" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ObNotifyTripStart {
    ...
    @XmlElement(name = "actual-start-time", required = true)
    protected String actualStartTime;
    @XmlElement(name = "trip-info", required = true)
    protected CCPTVTripData tripInfo;
    protected tcip_3_0_5_local.ObNotifyTripStart localObNotifyTripStart;
     ...
     * @return
     *     possible object is
     *     {@link tcip_3_0_5_local.ObNotifyTripStart }
     *     
     */
    public tcip_3_0_5_local.ObNotifyTripStart getLocalObNotifyTripStart() {
     ...
     *     
     */
    public void setLocalObNotifyTripStart(tcip_3_0_5_local.ObNotifyTripStart value) {
