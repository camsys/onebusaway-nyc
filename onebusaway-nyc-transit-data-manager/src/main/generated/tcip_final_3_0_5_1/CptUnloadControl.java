 ...
 *                   &lt;element name="deleted-files" type="{http://www.TCIP-Final-3-0-5-1}CPTUnloadFileHeader"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="file-to-unload" type="{http://www.TCIP-Final-3-0-5-1}CPTUnloadFileHeader" minOccurs="0"/>
 *       &lt;/sequence>
...
public class CptUnloadControl {
    ...
    public static class DeletedFiles {
        ...
        @XmlElement(name = "deleted-files", required = true)
        protected List<CPTUnloadFileHeader> deletedFiles;
         ...
         * This is why there is not a <CODE>set</CODE> method for the deletedFiles property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDeletedFiles().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<CPTUnloadFileHeader> getDeletedFiles() {
            if (deletedFiles == null) {
                deletedFiles = new ArrayList<CPTUnloadFileHeader>();
            }
