...
/**
 * 
 * Either the CCLogOnOperator, or the CCLogOffOperator element must be present. 
 * Optionally, both may be present
 * 
 * 
 * <p>Java class for ObSignon complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ObSignon">
 *   &lt;complexContent>
 ...
 *         &lt;element name="requester" type="{http://www.TCIP-Final-3-0-5-1}OB-MID"/>
 *         &lt;element name="logon" type="{http://www.TCIP-Final-3-0-5-1}CCLogOnOperator" minOccurs="0"/>
 *         &lt;element name="logoff" type="{http://www.TCIP-Final-3-0-5-1}CCLogOffOperator" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ObSignon", propOrder = {
    "subscriptionInfo",
    "languages",
    "requester",
    "logon",
...
public class ObSignon {

    @XmlElement(required = true)
    protected CPTSubscriptionHeader subscriptionInfo;
    protected CPTLanguageList languages;
    protected short requester;
    protected CCLogOnOperator logon;
    protected CCLogOffOperator logoff;
     ...
     * 
     */
    public void setRequester(short value) {
     ...
     *     
     */
    public CCLogOnOperator getLogon() {
        return logon;
    }
     ...
     *     
     */
    public void setLogon(CCLogOnOperator value) {
        this.logon = value;
    }
     ...
     *     
     */
    public CCLogOffOperator getLogoff() {
        return logoff;
    }
     ...
     *     
     */
    public void setLogoff(CCLogOffOperator value) {
        this.logoff = value;
    }
