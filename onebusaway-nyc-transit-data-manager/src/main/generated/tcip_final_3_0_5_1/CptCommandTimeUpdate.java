 ...
 *         &lt;element name="current-time" type="{http://www.TCIP-Final-3-0-5-1}CPT-DateTime"/>
 *         &lt;element name="utc-offset" type="{http://www.TCIP-Final-3-0-5-1}CPT-Duration" minOccurs="0"/>
...
public class CptCommandTimeUpdate {
    ...
    @XmlElement(name = "current-time", required = true)
