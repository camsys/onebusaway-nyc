 ...
 *         &lt;element name="will-respond" type="{http://www.TCIP-Final-3-0-5-1}CPT-Boolean"/>
 *         &lt;element name="eta-time" type="{http://www.TCIP-Final-3-0-5-1}CPT-DateTime" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ImCommandIncidentResponseAck {
    ...
    @XmlElement(name = "eta-time")
    protected String etaTime;
     ...
     *     
     */
    public void setEtaTime(String value) {
        this.etaTime = value;
    }
