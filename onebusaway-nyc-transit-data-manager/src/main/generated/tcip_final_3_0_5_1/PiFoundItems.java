...
/**
 * <p>Java class for PiFoundItems complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PiFoundItems">
 *   &lt;complexContent>
 ...
 *         &lt;element name="lost-items">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="lost-item" type="{http://www.TCIP-Final-3-0-5-1}PILostItem"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="found-items" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="found-item" type="{http://www.TCIP-Final-3-0-5-1}PIFoundItem"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "PiFoundItems", propOrder = {
    "subscriptionHeader",
    "languages",
    "lostItems",
    "foundItems"
})
public class PiFoundItems {

    @XmlElement(required = true)
    protected CPTSubscriptionHeader subscriptionHeader;
    protected CPTLanguageList languages;
    @XmlElement(name = "lost-items", required = true)
    protected PiFoundItems.LostItems lostItems;
    @XmlElement(name = "found-items")
    protected PiFoundItems.FoundItems foundItems;
    ...
    /**
     * Gets the value of the lostItems property.
     * 
     * @return
     *     possible object is
     *     {@link PiFoundItems.LostItems }
     *     
     */
    public PiFoundItems.LostItems getLostItems() {
        return lostItems;
    }

    /**
     * Sets the value of the lostItems property.
     * 
     * @param value
     *     allowed object is
     *     {@link PiFoundItems.LostItems }
     *     
     */
    public void setLostItems(PiFoundItems.LostItems value) {
        this.lostItems = value;
    }

    /**
     * Gets the value of the foundItems property.
     * 
     * @return
     *     possible object is
     *     {@link PiFoundItems.FoundItems }
     *     
     */
    public PiFoundItems.FoundItems getFoundItems() {
        return foundItems;
    }

    /**
     * Sets the value of the foundItems property.
     * 
     * @param value
     *     allowed object is
     *     {@link PiFoundItems.FoundItems }
     *     
     */
    public void setFoundItems(PiFoundItems.FoundItems value) {
    ...
    public static class FoundItems {
        ...
        @XmlElement(name = "found-item", required = true)
        protected List<PIFoundItem> foundItem;

        /**
         * Gets the value of the foundItem property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the foundItem property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getFoundItem().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<PIFoundItem> getFoundItem() {
            if (foundItem == null) {
                foundItem = new ArrayList<PIFoundItem>();
            }
    ...
    public static class LostItems {
        ...
        @XmlElement(name = "lost-item", required = true)
        protected List<PILostItem> lostItem;

        /**
         * Gets the value of the lostItem property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the lostItem property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getLostItem().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<PILostItem> getLostItem() {
            if (lostItem == null) {
                lostItem = new ArrayList<PILostItem>();
            }
