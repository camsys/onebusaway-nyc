...
/**
 * <p>Java class for SchPushMasterScheduleVersion complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SchPushMasterScheduleVersion">
 *   &lt;complexContent>
 ...
 *         &lt;element name="included-routes">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="included-route" type="{http://www.TCIP-Final-3-0-5-1}SCHRouteIden"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="versionInfo" type="{http://www.TCIP-Final-3-0-5-1}SCHRouteVersion"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "SchPushMasterScheduleVersion", propOrder = {
    "pushHeader",
    "languages",
    "includedRoutes",
    "versionInfos"
})
public class SchPushMasterScheduleVersion {

    @XmlElement(required = true)
    protected CPTPushHeader pushHeader;
    protected CPTLanguageList languages;
    @XmlElement(name = "included-routes", required = true)
    protected SchPushMasterScheduleVersion.IncludedRoutes includedRoutes;
    @XmlElement(required = true)
    protected SchPushMasterScheduleVersion.VersionInfos versionInfos;
    ...
    /**
     * Gets the value of the includedRoutes property.
     * 
     * @return
     *     possible object is
     *     {@link SchPushMasterScheduleVersion.IncludedRoutes }
     *     
     */
    public SchPushMasterScheduleVersion.IncludedRoutes getIncludedRoutes() {
        return includedRoutes;
    }

    /**
     * Sets the value of the includedRoutes property.
     * 
     * @param value
     *     allowed object is
     *     {@link SchPushMasterScheduleVersion.IncludedRoutes }
     *     
     */
    public void setIncludedRoutes(SchPushMasterScheduleVersion.IncludedRoutes value) {
        this.includedRoutes = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link SchPushMasterScheduleVersion.VersionInfos }
     *     
     */
    public SchPushMasterScheduleVersion.VersionInfos getVersionInfos() {
        return versionInfos;
    }
     ...
     *     
     */
    public void setVersionInfos(SchPushMasterScheduleVersion.VersionInfos value) {
    ...
    public static class IncludedRoutes {

        @XmlElement(name = "included-route", required = true)
        protected List<SCHRouteIden> includedRoute;

        /**
         * Gets the value of the includedRoute property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the includedRoute property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getIncludedRoute().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<SCHRouteIden> getIncludedRoute() {
            if (includedRoute == null) {
                includedRoute = new ArrayList<SCHRouteIden>();
            }
            return this.includedRoute;
        }
    ...
    public static class VersionInfos {
        ...
        @XmlElement(required = true)
        protected List<SCHRouteVersion> versionInfo;
         ...
         * 
         */
        public List<SCHRouteVersion> getVersionInfo() {
            if (versionInfo == null) {
                versionInfo = new ArrayList<SCHRouteVersion>();
            }
