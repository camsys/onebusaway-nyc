...
/**
 * <p>Java class for SpLocationConversionSub complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SpLocationConversionSub">
 *   &lt;complexContent>
 ...
 *         &lt;element name="point-requests">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence maxOccurs="unbounded">
 *                   &lt;element name="point-request" type="{http://www.TCIP-Final-3-0-5-1}SPLocationConversionRequest"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "SpLocationConversionSub", propOrder = {
    "subscriptionInfo",
    "languages",
    "pointRequests"
})
public class SpLocationConversionSub {

    @XmlElement(required = true)
    protected CPTSubscriptionHeader subscriptionInfo;
    protected CPTLanguageList languages;
    @XmlElement(name = "point-requests", required = true)
    protected SpLocationConversionSub.PointRequests pointRequests;
    ...
    /**
     * Gets the value of the pointRequests property.
     * 
     * @return
     *     possible object is
     *     {@link SpLocationConversionSub.PointRequests }
     *     
     */
    public SpLocationConversionSub.PointRequests getPointRequests() {
        return pointRequests;
    }

    /**
     * Sets the value of the pointRequests property.
     * 
     * @param value
     *     allowed object is
     *     {@link SpLocationConversionSub.PointRequests }
     *     
     */
    public void setPointRequests(SpLocationConversionSub.PointRequests value) {
        this.pointRequests = value;
    }
    ...
    public static class PointRequests {

        @XmlElement(name = "point-request", required = true)
        protected List<SPLocationConversionRequest> pointRequest;

        /**
         * Gets the value of the pointRequest property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the pointRequest property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getPointRequest().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link SPLocationConversionRequest }
         * 
         * 
         */
        public List<SPLocationConversionRequest> getPointRequest() {
            if (pointRequest == null) {
                pointRequest = new ArrayList<SPLocationConversionRequest>();
            }
