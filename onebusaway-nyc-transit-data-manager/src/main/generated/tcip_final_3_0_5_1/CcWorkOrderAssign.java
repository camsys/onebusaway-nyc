 ...
 *         &lt;element name="time-assigned" type="{http://www.TCIP-Final-3-0-5-1}CPT-DateTime"/>
 *         &lt;element name="work-order" type="{http://www.TCIP-Final-3-0-5-1}CCWorkOrder"/>
 *         &lt;element name="localCcWorkOrderAssign" type="{http://www.tcip-3-0-5-local}CcWorkOrderAssign" minOccurs="0"/>
 *       &lt;/sequence>
...
public class CcWorkOrderAssign {
    ...
    @XmlElement(name = "time-assigned", required = true)
    protected String timeAssigned;
    @XmlElement(name = "work-order", required = true)
    protected CCWorkOrder workOrder;
    protected tcip_3_0_5_local.CcWorkOrderAssign localCcWorkOrderAssign;
     ...
     *     
     */
    public void setTimeAssigned(String value) {
     ...
     * @return
     *     possible object is
     *     {@link tcip_3_0_5_local.CcWorkOrderAssign }
     *     
     */
    public tcip_3_0_5_local.CcWorkOrderAssign getLocalCcWorkOrderAssign() {
     ...
     *     
     */
    public void setLocalCcWorkOrderAssign(tcip_3_0_5_local.CcWorkOrderAssign value) {
