 ...
 *         &lt;element name="arriveTimeScheduled" type="{http://www.TCIP-Final-3-0-5-1}CPT-DateTime"/>
 *         &lt;element name="vehicleLocation" type="{http://www.lrms-final-09-07}GeoLocation"/>
 *         &lt;element name="offScheduleTime" type="{http://www.TCIP-Final-3-0-5-1}CPT-Duration"/>
...
public class PISchedAdherenceOffSched {
    ...
    @XmlElement(required = true)
    protected String arriveTimeScheduled;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setArriveTimeScheduled(String value) {
