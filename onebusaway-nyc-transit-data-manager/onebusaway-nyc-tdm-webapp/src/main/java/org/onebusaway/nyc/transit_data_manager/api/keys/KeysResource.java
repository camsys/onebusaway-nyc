...
//
  ...
  @GET
  @Produces("application/json")
  public Response createKey(@PathParam("keyValue") String keyValue) throws JsonGenerationException,
      JsonMappingException, IOException {
  ...
  @GET
  @Produces("application/json")
  public Response deleteKey(@PathParam("keyValue") String keyValue) throws JsonGenerationException,
      JsonMappingException, IOException {
  ...
  private void saveOrUpdateKey(String apiKey, Long minApiRequestInterval) throws Exception {
  ...
  private Response generateResponse(Message message) throws IOException, JsonGenerationException, JsonMappingException {
    Response response;
