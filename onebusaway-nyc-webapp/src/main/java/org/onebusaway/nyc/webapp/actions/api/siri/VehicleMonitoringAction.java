...
public class VehicleMonitoringAction extends OneBusAwayNYCActionSupport 
  ...
  public String execute() {  
    ...
    if(agencyId != null && routeId != null) {
      ...
      _response = generateSiriResponse(_realtimeService.getVehicleActivityForRoute(routeIdWithAgency, directionId, 
          includeOnwardCalls));
    ...
    if(agencyId != null && vehicleId != null) {
      ...
      activities.add(_realtimeService.getVehicleActivityForVehicle(vehicleIdWithAgency, 
          includeOnwardCalls));
    ...
    // *** CASE 3: all vehicles
      ...
      ListBean<VehicleStatusBean> vehicles = 
          _transitDataService.getAllVehiclesForAgency(agencyId, _now.getTime());

      for (VehicleStatusBean v : vehicles.getList()) {
        activities.add(_realtimeService.getVehicleActivityForVehicle(v.getVehicleId(), includeOnwardCalls));
      }
    }
