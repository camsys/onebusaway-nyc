 ...
 *
 */
public class RouteResultV2 implements SearchResult {

	private RouteBean route;

	private List<RouteDirectionV2> directions;

	public RouteResultV2(RouteBean route, List<RouteDirectionV2> directions) {
		this.route = route;
	...
	public List<RouteDirectionV2> getDirections() {
		return directions;
	}
}
