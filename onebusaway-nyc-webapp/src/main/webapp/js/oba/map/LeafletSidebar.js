					...
					case "GeocodeResult":
						...
						if(matches[0].isRegion === true) {
							...
							var latLngBounds = new L.LatLngBounds(
									new L.LatLng(matches[0].bounds.minLat, matches[0].bounds.minLon), 
									new L.LatLng(matches[0].bounds.maxLat, matches[0].bounds.maxLon));
						...
						// result is a point--intersection or address
							...
							var latlng = new L.LatLng(matches[0].latitude, matches[0].longitude);
