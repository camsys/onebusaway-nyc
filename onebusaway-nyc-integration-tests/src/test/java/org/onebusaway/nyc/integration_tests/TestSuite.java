...
import org.onebusaway.nyc.integration_tests.vehicle_tracking_webapp.cases.Trace_5040_incrementing_trips_IntegrationTest;
...
@Suite.SuiteClasses({ 
	 ...
	 * Inference tests
	 */
	Trace_5040_incrementing_trips_IntegrationTest.class,
