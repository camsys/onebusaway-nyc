...
public class NycBundleManagementServiceImpl implements NycBundleManagementService {
  ...
  private static Logger _log = LoggerFactory.getLogger(NycBundleManagementServiceImpl.class);
  ...
  @Autowired
  private HttpServiceClient _restApiLibrary;
