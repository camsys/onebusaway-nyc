...
import org.onebusaway.nyc.stif.model.SignCodeRecord;
...
public class TestStifRecordReader {
	...
	public void testRecordReader() throws IOException {
	      ClassLoader loader = TestStifRecordReader.class.getClassLoader();
	      InputStream in = loader.getResourceAsStream("stif.m_0014__.210186.sun");
