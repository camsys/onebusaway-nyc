...
public class TripRecordFactory extends StifRecordFactory<TripRecord> {
	static class FieldDef extends StifFieldDefinition <TripRecord>{
		public FieldDef(int length, String name,
				StifFieldSetter<TripRecord> setter) {
	...
	private static StifFieldDefinition[] fields = {
		...
		new FieldDef(59-53, "primary run route", new TripFieldSetter() {
			public void setField(TripRecord record) {record.setRoute(getStringData());}}),
		...
		new FieldDef(88-84, "sign code", new TripFieldSetter() {
			public void setField(TripRecord record) {record.setSignCode(getStringData());}}),
		...
		new FieldDef(126-116, "block number", new TripFieldSetter() {
			public void setField(TripRecord record) {record.setBlockNumber(getStringData());}}),
		...
		new FieldDef(161-155, "sign code route for this trip", null),
