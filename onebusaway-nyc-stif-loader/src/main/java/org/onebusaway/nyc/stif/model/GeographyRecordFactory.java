...
public class GeographyRecordFactory extends StifRecordFactory<GeographyRecord> {
	...
	static {
		...
		new FieldDef(7-3, "identifier", new GeographyFieldSetter() {
			public void setField(GeographyRecord record) {record.setIdentifier(getStringData());}}),
		...
		new FieldDef(88-78, "latitude", new GeographyFieldSetter() {
			public void setField(GeographyRecord record) {record.setLatitude(getDecimalFixedPoint(2));}}),
		new FieldDef(98-88, "latitude", new GeographyFieldSetter() {
			public void setField(GeographyRecord record) {record.setLongitude(getDecimalFixedPoint(2));}}),
		new FieldDef(99-98, "empty", null),			
		new FieldDef(105-99, "box id", new GeographyFieldSetter() {
			public void setField(GeographyRecord record) {record.setBoxID(getStringData());}}),
