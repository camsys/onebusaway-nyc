...
public class DistAlongDevDist implements
  ...
  public void updatePrior(Double schedDev, ScheduleDevParams condInput) {
    ...
    _distAlongDevTransVarParams[1] += Math
        .pow(schedDev - _distAlongDevSample, 2.0);
    /*
     * predictive variance
     */
    ...
    _distAlongDevVarParams[1] += Math
        .pow(_lastDevSample - _distAlongDevSample, 2.0);
  ...
  public Double sample(ScheduleDevParams params) {
    ...
    _distAlongDevSample = HalfNormalGen.nextDouble(_rng, _distAlongDevKalmanParams[0],
        Math.sqrt(_distAlongDevKalmanParams[1]));
    return _distAlongDevSample;
  }
  ...
  public String toString() {
    ...
    b.append("scheduleDevVarParams=")
        .append(Arrays.toString(_distAlongDevVarParams)).append(",");
    b.append("scheduleDevMeanParams=")
        .append(Arrays.toString(_distAlongDevKalmanParams)).append(",");
    b.append("scheduleDevTransVarParams=")
        .append(Arrays.toString(_distAlongDevTransVarParams)).append(",");
