 ...
 *
 */
public class KafkaOutputQueueSenderServiceImpl implements OutputQueueSenderService,
    ServletContextAware {

  private static Logger _log = LoggerFactory.getLogger(KafkaOutputQueueSenderServiceImpl.class);
