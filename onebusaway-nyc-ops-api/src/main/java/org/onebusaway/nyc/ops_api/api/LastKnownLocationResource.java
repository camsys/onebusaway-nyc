package org.onebusaway.nyc.ops_api.api;
...
import org.onebusaway.nyc.ops_api.api.json.JsonTool;
import org.onebusaway.nyc.ops_api.api.json.LastKnownRecordMessage;
...
import org.onebusaway.nyc.ops_api.services.CcAndInferredLocationDao;
...
public class LastKnownLocationResource {
	...
	public void set_locationDao(CcAndInferredLocationDao _locationDao) {
